<header>
    ...
    >
      ...
      <div class="hidden md:flex justify-center items-center w-full md:w-auto">
        <a id="botoncotizar"
         target="_blank" href="https://api.whatsapp.com/send?phone=51946260675&text=¡Hola%20Hidromec!%20Quisiera%20recibir%20más%20detalles%20sobre%20sus%20productos%20y%20servicios%20especializados%20en%20Agricultura." rel="noopener"
    ...
    <div class="flex justify-end w-11/12 mx-auto  z-10">
      <div class="fixed bottom-6 sm:bottom-[2rem] lg:bottom-[4rem] z-20">
          <a target="_blank" href="https://api.whatsapp.com/send?phone=51946260675&text=¡Hola%20Hidromec!%20Quisiera%20recibir%20más%20detalles%20sobre%20sus%20productos%20y%20servicios%20especializados%20en%20Agricultura." rel="noopener">
